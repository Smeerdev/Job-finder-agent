...
class TestEnrich:
    ...
    def test_text_stated_cycle_replaces_inferred(self):
        ...
        job.season, job.season_inferred = "2026 Graduates", True
        _run(enrich.enrich_jobs([job], {}, net))
        assert job.season == "2026 Graduates"
    ...
    def test_title_stated_cycle_never_overridden_by_text(self):
        ...
        job.season, job.season_inferred = "2026 Graduates", False  # year was in the title
        _run(enrich.enrich_jobs([job], {}, net))
        assert job.season == "2026 Graduates"
